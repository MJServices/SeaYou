  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        ...
        print(
            '🎵 Before toggle - muted: ${GlobalAudioController.instance.muted.value}');
        ...
        Future.delayed(const Duration(milliseconds: 100), () {
          print(
              '🎵 After toggle - muted: ${GlobalAudioController.instance.muted.value}');
            ...
            SafeArea(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(
                        24, 0, 24, 24), // Increased bottom padding
                    child: Column(
